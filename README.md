...
const paragraph = "My name is Bini Yetayeh. I live in Finland, Helsinki.\
...
let firstName = 'Desta'      // string
let lastName = 'Geta'        // string
let country = 'Ethiopia'         // string
let city = 'Bahir Dar'           // string
let age = 30                   // number, it is not my real age, do not worry about it
let job                         // undefined, because a value was not assigned

console.log(typeof 'Desta')  // string
